...
- (void)initCategoryMenu{
    ...
    MultilevelMenu * view=[[MultilevelMenu alloc] initWithFrame:CGRectMake(0, 2, self.view.width, self.view.height - 2) WithModel:self.categoryVM withSelectIndex:^(NSInteger left, NSInteger right,CategoryMeunModel * info) {
