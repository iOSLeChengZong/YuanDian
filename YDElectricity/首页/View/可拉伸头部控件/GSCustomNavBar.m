...
- (UIButton *)leftBtn
{
    if (!_leftBtn) {
        ...
        [_leftBtn setImage:bgImg forState:UIControlStateNormal];
...
- (UIButton *)rightBtn
{
    if (!_rightBtn) {
        ...
        [_rightBtn setImage:bgImg forState:UIControlStateNormal];
...
- (void)setRightImage:(NSString *)rightImage
{
    ...
    [self.rightBtn setImage:[UIImage imageNamed:_rightImage] forState:UIControlStateNormal];
