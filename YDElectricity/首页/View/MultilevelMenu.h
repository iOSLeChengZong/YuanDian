...
@property (strong,nonatomic) CategoryViewModel *categoryVM;

//用于记录上一个被点击的cell 下标
@property(assign,nonatomic) NSInteger oldCellIndex;
...
-(id)initWithFrame:(CGRect)frame WithModel:(CategoryViewModel *)categoryVM withSelectIndex:(void(^)(NSInteger left,NSInteger right,id info))selectIndex;
