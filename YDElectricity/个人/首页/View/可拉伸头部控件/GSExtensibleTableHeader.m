...
-(UITableView *)tableView{
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0.f, 0.f, kScreenW, kScreenH ) style:UITableViewStylePlain];
        _tableView.delegate = self;
        _tableView.dataSource = self;
        [_tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:cellID];
        
        UIView *headerView = [[UIView alloc] initWithFrame:CGRectMake(0.f, 0.f, kScreenW, headHeight)];
...
- (void)setupHeaderImg{
    bgView = [[UIImageView alloc] initWithFrame:CGRectMake(0.f, 0.f, kScreenW, headHeight)];
